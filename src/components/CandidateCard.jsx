...
const CandidateCard = ({imageUrl, candidateName, qualification, partyName, numberOfVotes, disabled}) => {
  ...
  return (
    <button disabled={disabled} className='bg-[#D9D9D9] mx-auto my-5 flex rounded-lg w-[350px] sm:w-[450px] items-center gap-3 sm:w-[500px]:gap-4 justify-between' onClick={voteParty}>
        <div className='bg-white w-[100px] h-[100px] m-3 rounded-lg'><img className='min-w-[100px] min-h-[100px] object-contain' src={imageUrl} /></div>
